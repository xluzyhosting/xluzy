...
check_token() {
  echo -e "                                                       "
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "${BLUE}[+]               LICENSE XLUZYHOST           [+]${NC}"
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
  echo -e "${YELLOW}MASUKAN AKSES TOKEN :${NC}"
  read -r USER_TOKEN

  if [ "$USER_TOKEN" = "xluzymodzz" ]; then
...
if [ "$SELECT_THEME" -eq 1 ]; then
  ...
  echo -e "                                                                   "
    ...
    sudo sed -i "s|https://wa.me/6287712933029|$LINK_WA|g" /root/pterodactyl/resources/scripts/components/dashboard/DashboardContainer.tsx
    sudo sed -i "s|https://chat.whatsapp.com/D6EMJU8sRhU0RK7avhF1RF|$LINK_GROUP|g" /root/pterodactyl/resources/scripts/components/dashboard/DashboardContainer.tsx
    sudo sed -i "s|https://whatsapp.com/channel/0029VajZ3PEH5JLrK0nZV82O|$LINK_CHNL|g" /root/pterodactyl/resources/scripts/components/dashboard/DashboardContainer.tsx
...
while true; do
  ...
  echo -e "${RED}'ggg      ,gg'''  .    ggg       Auto IInstaller XluzyHost   ${NC}"
  echo -e "${RED}gggg      gg     ,     ggg      ------------------------  ${NC}"
  echo -e "${RED}ggg:     gg.     -   ,ggg       • Telegram : @xluzyhost1      ${NC}"
  echo -e "${RED} ggg:     ggg._    _,ggg        • Creadit  : XLUZYHOST  ${NC}"
  echo -e "${RED} ggg.    '.'''ggggggp           • Support by XLUZYHOST  ${NC}"
